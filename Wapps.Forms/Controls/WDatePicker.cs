...
namespace Wapps.Forms.Controls
{
	public class WDatePicker : DatePicker
	{
		...
		/// The font property
		/// </summary>
		public static readonly BindableProperty FontProperty = BindableProperty.Create("Font", typeof(Font), typeof(WDatePicker), new Font());
		...
		/// The font property
		/// </summary>
		public static readonly BindableProperty FontSizeProperty = BindableProperty.Create("FontSize", typeof(double), typeof(WDatePicker), (double)14);
